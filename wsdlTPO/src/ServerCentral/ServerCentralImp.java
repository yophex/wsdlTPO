...
public class ServerCentralImp implements ServerCentral {
    ...
    public ServerCentralImp(String ipHoroscopo, int portHoroscopo, String ipClima, int portClima) {
        ...
        try {
            ...
            this.servicioHoroscopo = Service.create(urlHoroscopo, qnameHoroscopo).getPort(ServerHoroscopo.class);
            ...
            this.servicioClima = Service.create(urlClima, qnameClima).getPort(ServerClima.class);
    ...
    public ArrayList<String> getPronostico(String horoscopo, String fecha, String clientName) {
        // Se verifica que la solicitud sea valida y se responde con un
    ...
    private String validacion(String horoscopo, String fecha) {
        ...
        // Primero se verifica si es valido para el Protocolo Clima y luego para el de
        // Horoscopo
    ...
    private String validarFecha(String fecha) {
        ...
        // Se verifica que la fecha recibida cumpla el formato DD-MM-A... (el a�o puede
        // ser desde 0 en adelante)
        if (indexA == 2 && indexB == 5 && fecha.length() >= 7) {
            ...
            if (dia >= 1 && dia <= 31) {
                ...
                if (mes == 2) {
                    ...
                    // Si no es feberero, se verifican para los meses restantes si tiene 30 o 31
                    // dias
